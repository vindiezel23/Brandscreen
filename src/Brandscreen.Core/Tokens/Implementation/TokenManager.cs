...
namespace Brandscreen.Core.Tokens.Implementation {
    public class TokenManager : ITokenManager {
        ...
        private class DescribeContextImpl : DescribeContext {
            ...
            public override DescribeFor For(string target, string name, string description) {
        ...
        private class DescribeForImpl : DescribeFor {
            ...
            public DescribeForImpl(string target, string name, string description) {
                _target = target;
                _name = name;
            ...
            public override DescribeFor Token(string token, string name, string description) {
                return Token(token, name, description, null);
            }

            public override DescribeFor Token(string token, string name, string description, string chainTarget) {
