...
{
    public class SegmentQueryViewModel : Pagination
    {
    ...
    public class SegmentQueryViewModelMapper : Profile
    {
        protected override void Configure()
        {
            CreateMap<SegmentQueryViewModel, SegmentQueryOptions>()
                .ConstructUsing(ctx =>
                {
                    var source = (SegmentQueryViewModel) ctx.SourceValue;
                    var retVal = new SegmentQueryOptions();
